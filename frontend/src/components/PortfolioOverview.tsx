    ...
    return (
      <div className={`bg-white rounded-xl shadow-sm border border-gray-100 p-8 ${className}`}>
        <div className="text-center py-12">
          ...
          <p className="text-gray-600">Connect your wallet to view your portfolio and start optimizing your yields</p>
        </div>
      </div>
    )
  }
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium text-gray-900">Benqi Lending</span>
              </div>
            ...
            <div className="w-full bg-gray-200 rounded-full h-3">
              <div 
                ...
                style={{ 
                  width: portfolio 
                    ? `${(parseFloat(portfolio.allocation.benqiAmount) / parseFloat(portfolio.totalValue)) * 100}%`
                    : '40%'
                }}
              />
            </div>
          ...
          <div>
            ...
            <div className="w-full bg-gray-200 rounded-full h-3">
              <div 
                ...
                style={{ 
                  width: portfolio 
                    ? `${(parseFloat(portfolio.allocation.traderJoeAmount) / parseFloat(portfolio.totalValue)) * 100}%`
                    : '40%'
                }}
              />
            </div>
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium text-gray-900">YieldYak Farms</span>
              </div>
              <div className="text-right">
                <div className="font-semibold text-gray-900">
                  {portfolio 
            ...
            <div className="w-full bg-gray-200 rounded-full h-3">
              <div 
                ...
                style={{ 
                  width: portfolio 
                    ? `${(parseFloat(portfolio.allocation.yieldYakAmount) / parseFloat(portfolio.totalValue)) * 100}%`
                    : '20%'
                }}
              />
            </div>
        ...
        {rebalanceRec?.shouldRebalance && (
          <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="font-medium text-blue-900 mb-1">Rebalancing Recommended</div>
                <div className="text-sm text-blue-700">
                  Market conditions suggest rebalancing your portfolio for optimal returns.
                </div>
              </div>
            </div>
          </div>
