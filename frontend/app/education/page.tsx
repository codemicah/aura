...
export default function EducationPage() {
  const [activeTab, setActiveTab] = useState<'tutorials' | 'faq' | 'glossary'>('tutorials');
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      <main className="container mx-auto px-4 py-8 pt-24">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-400">Learn everything about DeFi wealth management</p>
            </div>
          </div>
        </div>
        ...
        {/* Protocol Guides */}
        <div className="mt-8">
          <h2 className="text-2xl font-bold text-white mb-6">Protocol Guides</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Benqi Guide */}
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-white">Benqi</h3>
                <span className="px-2 py-1 bg-green-500/20 text-green-400 rounded text-xs">Low Risk</span>
              </div>
              <p className="text-gray-400 text-sm mb-4">
                Decentralized lending protocol offering stable yields through supply and borrow markets.
              </p>
            ...
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="px-2 py-1 bg-yellow-500/20 text-yellow-400 rounded text-xs">Medium Risk</span>
              </div>
              <p className="text-gray-400 text-sm mb-4">
                Leading DEX on Avalanche with liquidity provision opportunities and trading fees.
              </p>
              <ul className="space-y-2 text-sm">
                <li className="flex items-start">
                  <span className="text-green-400 mr-2">✓</span>
            ...
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="px-2 py-1 bg-red-500/20 text-red-400 rounded text-xs">High Risk</span>
              </div>
              <p className="text-gray-400 text-sm mb-4">
                Auto-compounding yield optimizer maximizing returns through complex strategies.
              </p>
              <ul className="space-y-2 text-sm">
                <li className="flex items-start">
                  <span className="text-green-400 mr-2">✓</span>
