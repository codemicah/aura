...
contract YieldOptimizerTest is Test {
    ...
    function setUp() public {
        ...
        // Set up protocol addresses (mock addresses for testing)
        optimizer.updateProtocolAddress("traderjoe", makeAddr("traderjoe"));
        optimizer.updateProtocolAddress("benqi", makeAddr("benqi"));
        optimizer.updateProtocolAddress("yieldyak", makeAddr("yieldyak"));
    }

    // Test basic deployment and initialization
    function testDeployment() public view {
        // Check initial yields are set
        (uint256 benqiAPY, uint256 traderJoeAPY, uint256 yieldYakAPY, uint256 lastUpdated) = optimizer.getCurrentYields();
    ...
    function testConservativeRiskProfile() public {
        ...
        // Check user profile
        (uint8 storedRiskScore, uint256 totalDeposited, uint256 lastRebalance, bool autoRebalance) = 
        ...
        (uint256 benqiAmount, uint256 traderJoeAmount, uint256 yieldYakAmount) = 
    ...
    function testInvalidProtocolNameUpdate() public {
        ...
        optimizer.updateProtocolAddress("invalidprotocol", makeAddr("someAddress"));
    }
